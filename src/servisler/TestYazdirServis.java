...
* @since 17.04.2026
* <p>
* Programın geliştirme aşamasında farklı çıktılarını gözlemleyerek debug sürecini hızlandırması için
* yazılmış bir test sınıfıdır. Gerçek simülasyon sırasında KULLANILMAMALIDIR. 
* 
